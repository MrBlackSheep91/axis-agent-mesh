...
# Sourced by bin/audit-models.ts (REG-03 CI drift gate): it greps prod paths for
# these substrings and exits non-zero on any hit. Substrings (not full IDs) so
# every provider-prefixed form is caught (openai/, openai:, bare, etc.).
